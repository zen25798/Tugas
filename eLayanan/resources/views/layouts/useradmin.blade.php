    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('admin') }}">
                ...
                <div class="sidebar-brand-text mx-3">E-Layanan</div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/data-halaman') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Halaman</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ url('/data-perusahaan') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Data Badan Usaha</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('/datapengajuan/menara') }}">Menara Telekomunikasi</a>
                        <a class="collapse-item" href="{{ url('/datapengajuan/fiber') }}">Fiber Optic</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAcc" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('admin/dataakun/role') }}">Role</a>
                        <a class="collapse-item" href="{{ url('admin/dataakun/user') }}">User</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseWil"
                    aria-expanded="true" aria-controls="collapseWil">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Data Wilayah</span>
                </a>
                <div id="collapseWil" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('admin/datawilayah/kecamatan') }}">Kecamatan</a>
                        <a class="collapse-item" href="{{ url('admin/datawilayah/desa') }}">Desa</a>
                    </div>
                </div>
            </li>
