<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="rekomendasiModal{{ $f->id }}" tabindex="-1" role="dialog" aria-labelledby="rekomendasiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="rekomendasiModalLabel">Apakah anda yakin ingin memverifikasi {{ $f->id }}?</h5>
