        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="contact_form">
                    <form class=""  method="post" action="{{ action('FiberController@store')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-form-label">Badan Usaha</label>
                            <select id="id_post_perusahaan" name="id_post_perusahaan" class="form-control" required>
                        ...
                        @if (Auth::check())  
                            <div class="form-group">
                                ...
                                <input id="id_user" name="id_user" value="{{auth()->user()->id_user}}" placeholder="{{auth()->user()->nama_user}}" class="form-control" disabled>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label for="no_1">No Telepon</label>
                                        <input placeholder="{{auth()->user()->no_hp}}" class="form-control" disabled>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="email">Email</label>
                                        <input placeholder="{{auth()->user()->email}}" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>
                        @else
                        ...
                        @if (Auth::check())
                            <div class="form-group">
                                ...
                                <input id="file_ktp" value="{{auth()->user()->file_ktp}}" class="form-control" disabled>
                            </div>
                        @else
                            <div class="form-group">
                                <label for="file_ktp"> Berkas KTP</label>
